...
<div class="container container-navbar">
    <div class="collapse navbar-collapse " id="navmenu">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a href="index.php" class="nav-link mx-3 text-white fs-5">Faça Parte</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link mx-4 text-white fs-5">Notícias</a>
                    </li>

                    <li class="nav-item">
                        <a href="index.php" class="nav-link mx-4 text-white fs-5">Quem Somos</a>
                    </li>

                    <li class="nav-item">
                        <a href="adm.php" class="nav-link mx-4 text-white fs-5">Administrador</a>
                    </li>
