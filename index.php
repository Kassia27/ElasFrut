...
<div class="container container-navbar">
    <div class="collapse navbar-collapse " id="navmenu">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a href="#quemsomos" class="nav-link mx-4 text-white fs-5">Quem Somos</a>
                    </li>
 ...
 <div id="carouselExampleIndicators" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/banner3.jpg" class="d-block w-100" height="400" alt="...">
    ...
    <div class="carousel-item">
      <img src="img/banner2.jpg" class="d-block w-100" height="400" alt="...">
      <div class="carousel-caption d-none d-md-black">
            <h2>Quer anuciar?</h2>
            <p>Conte conosco, temos mais de 30 mil fornecedores anunciando.</p>
            <a href="#" class="main-btn">Ver fornecedoras</a>
